...
const Kmc_AllOpDeptWise = () => {
    ...
    const filterDeptData = useCallback((rangeStart, rangeEnd) => {
        try {
            ...
            // Return empty dataset on error to avoid crashes
            return {
                labels: [],
                datasets: []
            };
    ...
    const handlePeriodChange = useCallback((period) => {
        try {
            ...
            // Optionally handle UI error feedback here
        }
    ...
    useEffect(() => {
        try {
            ...
            console.error("Error in useEffect date parsing:", error.message);
            // Optionally set fallback state or notify user here
        }
