        ...
        >
            ...
            >
                <DashboardCard title="OP/IP Count">
                    <OP_IP_Statistics Displaystyle={1} fromDate={fromDate} setFromDate={setFromDate} toDate={toDate} setToDate={setToDate} />
                </DashboardCard>
            </Box>
            ...
            >
                <DashboardCard title="Doctor Wise Total OP/IP Count">
                    <Dr_Wise_IP_OP Displaystyle={1} fromDate={dr_fromDate} setFromDate={setdr_FromDate} toDate={dr_toDate} setToDate={setdr_ToDate} />
                </DashboardCard>
            </Box>
            <Box
                sx={{
...
export default memo(Kmch_Patient_Statiatics);
