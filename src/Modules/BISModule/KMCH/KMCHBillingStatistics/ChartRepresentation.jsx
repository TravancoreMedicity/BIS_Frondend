...
const ChartRepresentation = ({ Displaystyle, fromDate, setFromDate, toDate, setToDate, Graphicaldata }) => {
    ...
    // const data = useMemo(() => {
    //     const temp = Array.from({ length: 50 }, (_, i) => {
    //         const date = new Date();
    ...
    //         };
    //     });
    //     return temp.sort((a, b) => new Date(a.visit_date) - new Date(b.visit_date));
    // }, []);
...
export default memo(ChartRepresentation) 
