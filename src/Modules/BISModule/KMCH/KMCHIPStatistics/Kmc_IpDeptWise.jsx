...
const departmentDetails = [
    { dept_id: 1, dept_name: "General Surgery", visit_date: "2025-05-01", TotalIp: 100, TotalAdmisiion: 40 },
...
const Kmc_IpDeptWise = () => {
    ...
    const filterDeptData = useCallback((rangeStart, rangeEnd) => {
        ...
        const TotalAdmission = filtered.map(d => d.TotalAdmisiion);
...
export default memo(Kmc_IpDeptWise);
