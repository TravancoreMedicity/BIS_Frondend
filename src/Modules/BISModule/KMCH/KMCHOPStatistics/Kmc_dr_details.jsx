...
const Kmc_dr_details = () => {

    const { drslno, dr_name } = useParams();
    ...
    return (
        <Box>
            <DefaultPageLayout label={dr_name}>
                {/* <Grid container spacing={1} sx={{ flexGrow: 0, px: 1 }}>
                    ...
                    <Box sx={{ width: '100%', overflow: 'auto', mt: 2, p: 2 }}>
                        <Typography textAlign="center">{dr_name}</Typography>
...
export default memo(Kmc_dr_details);
