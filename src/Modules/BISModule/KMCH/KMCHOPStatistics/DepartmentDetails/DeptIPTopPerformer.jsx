...
// const DeptIPTopPerformer = ({ docList, chartData, setChartData, rawChartData, setRawChartData }) => {
...
// export default memo(DeptIPTopPerformer);
...
const DeptIPTopPerformer = ({ docList, chartData, setChartData }) => {
