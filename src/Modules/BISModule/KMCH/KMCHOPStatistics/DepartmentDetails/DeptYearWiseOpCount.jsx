            ...
            <Box sx={{ mt: 1 }}>
                <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2, flexWrap: 'wrap' }}>
                    <Box sx={{ border: 1, p: 2, borderColor: '#dbe0e9ff', flex: 1, minWidth: 0 }}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'space-between', alignItems: 'center', mt: 3, gap: 2 }}>
                        ...
                        <Box sx={{ width: '100%', height: { xs: 300, sm: 400 }, mt: 4 }}>
                            {Chartlayout === 1 ? (
...
export default memo(DeptYearWiseOpCount);
