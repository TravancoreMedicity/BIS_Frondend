...
const DeptLabBilling = ({ chartData, setChartData, rawChartData, setRawChartData }) => {
...
export default memo(DeptLabBilling);
...
// const DeptLabBilling = () => {
//     const [Chartlayout, seChartlayout] = useState(2);
